...
namespace {
struct qt_meta_tag_ZN16AddContactDialogE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN16AddContactDialogE = QtMocHelpers::stringData(
    "AddContactDialog",
    "validateAndAccept",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN16AddContactDialogE[] = {
...
Q_CONSTINIT const QMetaObject AddContactDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN16AddContactDialogE.offsetsAndSizes,
    qt_meta_data_ZN16AddContactDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16AddContactDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void *AddContactDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16AddContactDialogE.stringdata0))
